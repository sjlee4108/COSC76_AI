...
class CarShapes:
    ...
    def update_patch(self):
        self.car_poly = plt.Circle((self.q[0], self.q[1]), radius = 0.25)
...
class TrajectoryView:
    def __init__(self, traj, polygons = []):
        self.traj = traj
    ...
    def draw(self, ax, final_t):
        ...
        for p in self.polygons:
            obstacle = plt.Polygon(p,edgecolor='red', facecolor="red")
...
def animate1():
    ...
    def animate(i):
        ...
        tview = TrajectoryView(traj,[[[1,1],[2,1],[2,2],[1,2]]])
        tview.draw(ax, i * .05)
        #print(f"hello: {i}")
