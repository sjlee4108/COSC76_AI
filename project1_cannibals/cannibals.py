...
problem551 = CannibalProblem((5, 5, 1),boat_max = 3)
...
print(astar_search(problem551,zero))
...
#print("bfs: ",bfs_search(problem541))
#print("dfs: ",dfs_search(problem541))
#print("ids: ",ids_search(problem541))
